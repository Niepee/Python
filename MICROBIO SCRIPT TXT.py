...
table = []
df = pandas.DataFrame(columns=['Plaat Nr.', 'Naam', 'Datum', 'Proces', 'Klasse', 'Type', 'Locatie', 'Vervolg', 'Determinatie'])
...
df3 = df2.sort_values('Datum')

df3.to_excel(excel_writer="U:\\Python\\Microbio\\output_CB.xlsx", sheet_name= "Datasheet")
