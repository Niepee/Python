...
with open("U:\Python\Microbio/output_CB.txt", 'r') as f:
    data = f.read()
...
df.to_csv(path_or_buf="U:\Python\Microbio/output_CB.csv")
df.to_excel(excel_writer="U:\Python\Microbio/output_CB.xlsx")
